...
print ("Login Succes Selfbot By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨")
...
RfuBot=[lineMID]
Family=['ใส่ไอดีนะ',lineMID]
admin = ['ใส่ไอดีนะ',lineMID]
...
settings = {
    ...
    "pname": {},
    "pro_name": {},
    "man1":"By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨",
    "man2":"By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨",
    "man3":"By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨",
    "message":"บัญชีนี้ได้การป้องกันโดย Selfbot By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨ ระบบจะทำการบล็อคคุณ",
    "comment":"Selfbot By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨",
    "userAgent": [
...
def myhelp():
    myHelp = """╭══✨คำสั่งเฉพาะบัญชีนี้เทานั้น✨   
╠✨→About ✈ ข้อมูลบอท
╠✨→Help ✈ จะแสดงคำสั่ง
╠✨→Help2 ✈ จะแสดงคำสั่งตั่งค่า
╠✨→Help3 ✈ ชุดคำสังแปลกภาษา
╠✨→Me ✈ คทเรา
╠✨→Me @ ✈ ดึงคท
╠✨→Mymid ✈ MIdเรา
╠✨→Myname ✈ ชื่อเรา
...
╠✨→Copy @ ✈ ก็อปปก
╠✨→backup ✈ กับร่าง
╠✨→Mimic on/off ✈ เปิด/ปิดพิมตาม
╠✨→MimicList ✈ ดูคนทีพิมตาม
╠✨→MimicAdd @ ✈ พิมตาม
╠✨→MimicDel @ ✈ ลบพิมตาม
...
╠✨→GroupId ✈ ไอดีกลุ่ม
╠✨→GroupName ✈ ชื่อกลุ่ม
╠✨→GroupPicture ✈ ปกกลุ่ม
╠✨→GroupList ✈ ดูรายชื่อกลุ่ม
╠✨→GroupMemberList ✈ รายในกลุ่ม
╠✨→GroupInfo ✈ข้อมูลกลุ่ม
╠✨→Link on/off ✈เปิดปิดลิ่งกลุ่ม
╠✨→Gurl ✈ ขอลิ่งกลุ่ม
╠✨→Friendlist ✈ รายชื่อเพือนทั้งหมด
╠✨→Blocklist ✈ เชคคนติดดำ
╠✨→Invite:gcreator ✈ ผู้สร้างบอท
╠✨→Allban ✈ แบนดำทั้งห้อง
╠✨→แทค ✈ แทคได้100คน
╠✨→Tagall ✈ แคทได้500
╠✨→Lurking on ✈ ตั้งเวลา
╠✨→Lurking off ✈ ปิดเวลา
╠✨→Lurking reset ✈ ลบเวลาคนอ่าน
╠✨→Lurking ✈ ดูคนอ่าน
╠✨→Kick ✈ เตะด้วยแทต
╠✨→Ri ✈ เตะละเชิญกับ
╠✨→.denyall ✈ ลบรัน
...
╠✨→เชคดำ ✈ ดูคนติดดำ
╠✨→Zt ✈ แทคชื่อร่องหน
╠✨→Zc ✈ ดู"ไอดี"คนใส่ร่องหน
╠✨→Zm ✈ ดู"คท"คนใส่ร่องหน
╠✨→Mc
╠✨→info ✈ ดูข้อมูล
╠✨→.invitetocall ✈ เชิญโทร
╠✨→Me ✈ แทคคนทีจะเอาคท
╠✨→upbio: ✈ใสตัสได้ไม่จำกัด
╠✨→Youtube ✈ ค้นยูทูป
╠✨→Tgx ✈ เขียนเป็นรูป
╠✨→Anime ✈ ค้นรูปการ์ตูน
╠✨→Image ✈ ค้นรูป
╠✨→Pornhub ✈ เวปsex
╰══ By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨ ══"""
...
╠✨→Rn/Rf ✈ อ่านออโต้
╠✨→Bn/Bf ✈ บล็อคออโต้
╠✨→Jn/Jf ✈ เข้ากลุ่มออโต้
╠✨→Ln/Lf ✈ ออกแชทรวมออโต้
╠✨→Idn/Idf ✈ เปิด/ปิดอ่านไอดี  
╠✨→Sn/Sf ✈ แชร์ลิ้งโพส
╠✨→Stkn/Stkf ✈ แชร์ลิ้งสติ้กเกอร์
╠✨→Ptn/Ptf ✈ ระบบป้องกัน
╠✨→Zbkn/Zbkf ✈ ระบบทั้งหมด
╠✨→Gpn/Gpf ✈ กันสมาชิกดื้อ
╠✨→Ivpn/Ivpf ✈ ป้องกันเชิญ
╠✨→Jpn/Jpf ✈ ป้องกันคนเข้า
╠✨→Ccpn/Ccpf ✈ กันยกเชิญ
╠✨→Lpn/Lpf ✈ ป้องกันลิ้ง
╠✨→Cctv on/off ✈ จับคนอ่าน
╠✨→Selfbot off ✈ ปิดเชลบอท
╠════════════════
║        ✨  ตั้งข้อความ  ✨
╠════════════════
╠✨→Z˓ ✈ ตั้งข้อความคนเข้า
╠✨→Zz˓ ✈ ตั้งข้อความคนออก
╠✨→Zzz˓ ✈ ตั้งกล่าวถึงคนแทค
╠✨→Z˓ ✈ เช็คข้อความคนเข้า
╠✨→Zz˓✈ เช็คข้อความคนออก
╠✨→Zzz˓ ✈ เช็คข้อความคนแทค
╠✨→Zn/Zf ✈ กล่าวถึงคนเข้า
╠✨→Zzn/Zzf ✈ กล่าวถึงคนออก
╠✨→Tn/Tf ✈ ตอบแทค"แชท"
╠✨→Tn2/Tf2 ✈ ตอบแทค"รูป"
╠✨→Tn3/Tf3 ✈ ตอบแทก"ติ๊ก"
╰══ By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨ ══"""
...
#   line.sendText(op.param1,"บัญชีนี้ได้การป้องกันโดย\nSelfbot By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨\nระบบได้ทำการบล็อคคุณอัตโนมัติ")
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "เช็คความเร็ว...")
                    ...
                    try:
                        arr = []
                        owner = "ub45bf3a8805030b9d7c5877e8e405449"
                        creator = line.getContact(owner)
                        contact = line.getContact(lineMID)
                        grouplist = line.getGroupIdsJoined()
                        contactlist = line.getAllContactIds()
                        blockedlist = line.getBlockedContactIds()
                        ret_ = "╔══[ By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨ ]"
                        ret_ += "\n╠✨ชื่อไลน์ ═ {}".format(contact.displayName)
...
#==============================================================================#
                    ...
                    try:
                        ...
                        if settings["autoCancel"]["on"] == True:ret_+="\n╠✨ ยกเลิกเชิญกลุ่มที่สมาชิกต่ำกว่า: " + str(settings["autoCancel"]["members"]) + " → ✔"
                        else: ret_ += "\n╠✨ ยกเลิกเชิญกลุ่ม    ✘ "						
                    ...
                    line.sendMessage(to, "ปิดแชร์ลิ้งแล้ว.")
                elif text.lower() == 'sf':
                    ...
                    line.sendMessage(to, "เชคไอดีเปิดแล้ว")
                elif text.lower() == 'idf':
                    settings["contact"] = False
                    line.sendMessage(to, "เชคไอดีปิดแล้ว")
                elif text.lower() == 'tn3':
                    settings["Respontag"] = True
                    line.sendMessage(to, "ตอบแทคด้วยติ้ก เปิด")
                elif text.lower() == 'tf3':
                    settings["Respontag"] = False
                    line.sendMessage(to, "ตอบแทคด้วยติ้ก ปิด")					
                elif text.lower() == 'ln':
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "u5e998b0d52b0558905b98b8a4016d75a")
                    ...
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        ...
                        for ls in lists:
                            contact = line.getContact(ls)
                            line.sendMessage(msg.to, "✨ ชื่อเพื่อน ✨\n" + contact.displayName)
                    ...
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        ...
                        for ls in lists:
                            contact = line.getContact(ls)
                            line.sendMessage(msg.to, "✨ ตัสเพื่อน ✨\n{}" + contact.statusMessage)
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "หัวเน่ากลุ่ม..😅😅")
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == False:
                            ...
                            line.sendMessage(to, "ลิ้งคิวอาโค๊ด\nhttps://line.me/R/ti/g/{}".format(str(ticket)))
                elif text.lower() == 'link on':
                    if msg.toType == 2:
                        group = line.getGroup(to)
                        if group.preventedJoinByTicket == False:
                            line.sendMessage(to, "เปิดลิ้งคิวอาโค๊ด")
                        else:
                            group.preventedJoinByTicket = False
                            line.updateGroup(group)
                            line.sendMessage(to, "เปิดลิ้งคิวอาโค๊ดแล้ว")
                elif text.lower() == 'link off':
                    if msg.toType == 2:
                        group = line.getGroup(to)
                        if group.preventedJoinByTicket == True:
                            line.sendMessage(to, "ปิดลิ้งคิวอาโค๊ด")
                        else:
                            group.preventedJoinByTicket = True
                            line.updateGroup(group)
                            line.sendMessage(to, "ปิดลิ้งคิวอาโค๊ดแล้ว")
                    ...
                    path = "http://dl.profile.line-cdn.net/" + group.pictureStatus
                    ret_ = "╔══[ ✨ รายละเอียดกลุ่ม ✨ ]"
                    ret_ += "\n╠✨ ชื่อกลุ่ม : {}".format(str(group.name))
                    ret_ += "\n╠✨ ไอดีกลุ่ม : {}".format(group.id)
                    ret_ += "\n╠✨ หัวเน่ากลุ่ม : {}".format(str(gCreator))
                    ret_ += "\n╠✨ ประชากร : {}".format(str(len(group.members)))
                    ret_ += "\n╠✨ ค้างเชิญ : {}".format(gPending)
                    ret_ += "\n╠✨ สถานะลิ้ง : {}".format(gQr)
                    ret_ += "\n╠✨ อันนี่จักแม่นหยัง : {}".format(gTicket)
                    ret_ += "\n╚══[ By.✨Ձัधနุ่थ సန้ণ७Ҩथี้✨ ]"
                    line.sendMessage(to, str(ret_))
                    line.sendImageWithURL(to, path)
                    ...
                    if spl[0] == "":
                        ...
                        for i in range(len(prov)):
                            ...
                            try:
                                ...
                                pass
                            line.sendMessage(msg.to,"ชื่อ: "+userData.displayName)
                ...
                elif "zbk" in msg.text:
                    spl = msg.text.split("zbk")
                    if spl[len(spl)-1] == "":
...
#==============================================================================#   
                ...
                elif msg.text in ["Tn2","Tag2 on"]:
                        settings['potoMention'] = True
                        line.sendMessage(msg.to,"เปิดแทครูปแล้ว.")
                
                elif msg.text in ["Tf2","Tag2 off"]:
                        settings['potoMention'] = False
                        line.sendMessage(msg.to,"ปิดแทครูปแล้ว.")

                elif msg.text in ["Respontag on","Tag on","Tn","Respon:on"]:
                    settings["detectMention"] = True
                    line.sendMessage(msg.to,"เปิดแทคมาแทคกับแล้ว.")
                
                elif msg.text in ["Respontag off","Tag off","Tf","Respon:off"]:
...
#=============COMMAND PROTECT=========================#
                ...
                elif msg.text.lower() == 'ivpn':
                    if RfuProtect["inviteprotect"] == True:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"เปิดป้องกันเชิญสมาชิก   ")
                        else:
                            line.sendMessage(msg.to,"เปิดป้องกันเชิญแล้ว   ")
                    else:
                ...
                elif msg.text.lower() == 'ivpf':
                    if RfuProtect["inviteprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"ปิดป้องกันเชิญสมาชิกแล้ว   ")
                        else:
                            line.sendMessage(msg.to,"ปิดป้องกันเชิญสมาชิกแล้ว   ")
                    else:
...
#==============FINNISHING PROTECT========================#
                elif msg.text.lower() == 'zn':
                        if settings["Wc"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดข้อความต้อนรับสมาชิกเข้ากลุ่ม   .")
                        else:
                            settings["Wc"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดข้อความต้อนรับสมาชิกเข้ากลุ่ม   ")
                elif msg.text.lower() == 'zf':
                        if settings["Wc"] == False:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"ปิดข้อความต้อนรับสมาชิกเข้ากลุ่ม   ")
                        else:
                            settings["Wc"] = False
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"ปิดข้อความต้อนรับสมาชิกเข้ากลุ่ม   ")

                elif msg.text.lower() == 'zzn':
                        if settings["Lv"] == True:
                            if settings["lang"] == "JP":
                    ...
                    elapsed_time = time.time() - start
                    line.sendMessage(to, "ปฏิเสษกลุ่มเชิญแล้ว")
...
#                if msg.text in [""]:
#                    line.sendText(msg.to,"ยั้งอยู่ครับ😂")
#                if msg.text in [""]:
